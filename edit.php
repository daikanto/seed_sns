...
//パラメータのtweet_idを使ってtweetsデータを一件取得
 ...
 if (!empty($_POST)){
     ...
     if ($_POST['tweet']!='') {
         ...
         $sql =sprintf('UPDATE `tweets` SET `tweet`="%s" WHERE `tweet_id` =%d', mysqli_real_escape_string($db,$_POST['tweet']),mysqli_real_escape_string($db,$_REQUEST['tweet_id']));
    ...
    <div class="row">
      ...
      <?php if($tweet=mysqli_fetch_assoc($tweets)): ?>
        ...
        <div class="msg">
          ...
          <p>
            つぶやき : <br>
            <textarea name="tweet" id="" cols="50" rows="2"><?php echo $tweet['tweet']; ?></textarea>
          </p>
            <p class="day">
